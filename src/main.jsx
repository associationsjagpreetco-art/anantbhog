    ...
    <main>
      ...
      <section className="section categories" id="menu">
        ...
        <div className="categoryRow">
          <button className={`categoryCard ${category==="All"?"selected":""}`} onClick={()=>setCategory("All")}><div className="catAll">ALL</div><b>All</b><ChevronRight/></button>
          {categories.map(([name,img])=><button className={`categoryCard ${category===name?"selected":""}`} key={name} onClick={()=>setCategory(name)}><img src={img}/><b>{name}</b><ChevronRight/></button>)}
        </div>
      </section>
